...
runCli(dirOption.rest,{
  ...
  stdout:s=>process.stdout.write(s),stderr:s=>process.stderr.write(s),prompt,spawnAttach:spawnClaudeAttach,messenger:createResidentAgentMessenger(residentTransport(runCommand)),permissions:herdrPermissions(runCommand),
